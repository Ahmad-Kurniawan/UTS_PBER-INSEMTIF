...
public class AdapterKP extends RecyclerView.Adapter<AdapterKP.MyViewHolder> {
    private ArrayList<MahasiswaKP> list;
    public AppInterface appInterface;
    public AdapterKP(ArrayList<MahasiswaKP> list, AppInterface appInterface) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        MahasiswaKP currentMahasiswa = list.get(position);
